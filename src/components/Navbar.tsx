...
export function Navbar() {
  return (
    <header className="fixed left-1/2 top-6 z-50 w-[96%] lg:w-[98%] xl:w-[95%] max-w-[1450px] -translate-x-1/2 rounded-full">
        ...
        <div className="shrink-0">
          <a href="#" className="flex items-center">
            <img
              src="/images/1212.png"
              alt="BFF Logo"
              className="h-14 w-auto lg:h-16 scale-[1.35] lg:scale-[1.5] origin-left transition-transform duration-300 pointer-events-auto"
            />
          </a>
        </div>
