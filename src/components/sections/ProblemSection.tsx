...
function ProblemPointItem({ number, shortText, fullText }: ProblemPointProps) {
  ...
  return (
    <div className="flex flex-row items-start gap-3.5 group text-left bg-white dark:bg-zinc-900/90 border border-border/60 p-4.5 sm:p-6 rounded-2xl lg:flex-col lg:gap-0 lg:space-y-2 lg:bg-transparent lg:border-transparent lg:p-0 lg:rounded-none transition-colors hover:bg-white dark:hover:bg-zinc-900 shadow-sm">
